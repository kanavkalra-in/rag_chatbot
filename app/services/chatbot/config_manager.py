...
class ChatbotConfigManager:
    ...
    def __init__(self, config_filename: Optional[str] = None, config_dir: Optional[Path] = None):
        ...
        Args:
            ...
            config_dir: Directory containing config files (default: app/core/)
        """
    ...
    def _get_default_config_dir() -> Path:
        """Get default config directory (app/core/)."""
        # Path from app/services/chatbot/config_manager.py -> app/core/
        return Path(__file__).parent.parent.parent / "core"
